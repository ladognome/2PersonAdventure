...
namespace AlienGirl
{
    ...
    {
        #region Declarations
        String whoami; //a for alien, g for girl
        Inventory inv;
        Color fontColor;
        ...
        #region Constructors
        public Character(Texture2D texture, String who)
        {
        ...
        public Character(Texture2D texture, String who, Inventory i)
        {
            asSprite = new SpriteAnimation(texture);
            whoami = who;
            inv = i;
